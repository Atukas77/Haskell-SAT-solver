...
This project implements a SAT (satisfiability) solver in Haskell using the Tableaux method.It checks whether a given propositional logic formula can be made true under some assignment of truth values.
...
Once inside GHCi, you can directly call the checkSAT function with your formulas. Example:
